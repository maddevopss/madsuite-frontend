...
export function useProjets() {
  ...
  const startEditProjet = useCallback((projet) => {
    ...
    setEditForm({
      ...
      budget_hours: projet.budget_hours ?? "",
      budget_amount: projet.budget_amount ?? "",
    ...
    async (projetId) => {
      ...
      try {
        await updateProject(projetId, {
          ...
          budget_hours: Number(editForm.budget_hours || 0),
          budget_amount: Number(editForm.budget_amount || 0),
